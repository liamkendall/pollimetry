...
Together, lower lambda (not sure if we should be used lambda) but good result nonetheless. Suggests a non-PGLS model is best for predicting body size even if both BS and IT have phylo-signal.
