...
#Box plots
bee_RMSE=RMSE_sets%>%gather(.,c("JC87","LM1","PG1"),key ="Model",value = "RMSE")%>%ggplot(aes(x=Model,y=(RMSE),fill=Model))+geom_boxplot(pch=1)+theme_bw() + theme(aspect.ratio=1,axis.title.x=element_blank(),
