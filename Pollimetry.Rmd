...
colnames(RMSE_sets)=c("LM1","LM2","LM3","LM4","LM5","LM6","PG1","PG2","PG3","Cane 89")
RMSE_sets=as.data.frame(RMSE_sets)

#Box plots
bee_RMSE=RMSE_sets%>%gather(.,1:10,key ="Model",value = "RMSE")%>%ggplot(aes(x=Model,y=RMSE,fill=Model))+geom_boxplot()+theme_bw()+ theme(aspect.ratio=1)+ggtitle("Bees")
...
#Box plots
Hov_RMSE=Hov_RMSE_sets%>%gather(.,1:8,key ="Model",value = "RMSE")%>%ggplot(aes(x=Model,y=RMSE,fill=Model))+geom_boxplot()+theme_bw()+ theme(aspect.ratio=1)+ggtitle("Hoverflies")
