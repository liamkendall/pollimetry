...
#Save data files - Rdata files
```{r}
save(bee2,file="pollimetry/data/bee_tax_mod.Rdata")
save(bee_p1,file="pollimetry/data/bee_phy_mod.Rdata")
save(hov2,file="pollimetry/data/hov_mod.Rdata")
save(hov7,file="pollimetry/data/hov_tax_mod.Rdata")
save(bee_p3,file="pollimetry/data/bee_IT.Rdata")
save(hov1,file="pollimetry/data/hov_IT.Rdata")
save(poll_all,file="pollimetry/data/pollimetry_dataset.Rdata")
save(bee_mean,file="pollimetry/data/bee_mean_dataset.Rdata")
save(hov_mean,file="pollimetry/data/hov_mean_dataset.Rdata")
