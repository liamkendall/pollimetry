...
author: Liam Kendall, Romina Rader, Vesna Gagic, Daniel Cariveau, Matthias Albrecht,
  Katherine Baldock, Breno Freitas, Mark Hall, Janeally Pereira, Juanita Rodriguez, Laura Russo, Louis Sutter and Ignasi Bartomeus
date: "17/06/2018"
output:
...
BL_lm=lm(log(Spec.wgt)~log(IT),bee_species$Bombus_terrestris[bee_species$Bombus_terrestris$Sex == "Female",])
...
#3
plot(BL_IT,main="Bombus terrestris",ylab = "ITD (mm)",xlab="")
