...
colnames(RMSE_sets)=c("LM1","LM2","LM3","LM4","LM5","LM6","LM7","LM8","PG1","PG2","PG3","PG4","JC87")
...
Hov_K_sets=rbind(
  hov_model1%>%dplyr::select(.,13:18)%>%map_dbl(median,na.rm=T),
  hov_model2%>%dplyr::select(.,13:18)%>%map_dbl(median,na.rm=T),
  hov_model3%>%dplyr::select(.,13:18)%>%map_dbl(median,na.rm=T),
  hov_model4%>%dplyr::select(.,13:18)%>%map_dbl(median,na.rm=T),
  hov_model5%>%dplyr::select(.,13:18)%>%map_dbl(median,na.rm=T),
  hov_model6%>%dplyr::select(.,13:18)%>%map_dbl(median,na.rm=T),
  hov_model7%>%dplyr::select(.,13:18)%>%map_dbl(median,na.rm=T),
  hov_model8%>%dplyr::select(.,13:18)%>%map_dbl(median,na.rm=T))
