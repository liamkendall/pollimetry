...
#' 
#' @param x A dataframe with the following two columns: bee intertegular distance (IT) measurments in cm and Family, a vector of bee families. Only implemented 5 out of the extant 7 families: 
...
#' tonguelength2(example,mouthpart="all")
