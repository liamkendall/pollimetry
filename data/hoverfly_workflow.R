...
hov.full=lm(log(Spec.wgt) ~ log(IT) + Latitude + Sex + Subfamily + Country + #fix
...
#Top five models
summary(hov_dr_mods[1]$`142`) #Rsq 0.7492
summary(hov_dr_mods[2]$`14`) #Rsq 0.7447
summary(hov_dr_mods[3]$`143`) #Rsq 0.7407
