...
#' S93DB (Brachycera), Sabo02DB (Brachycera), Sabo02DA (Asilidae), Sabo02DBB (Bombyliidae), S93DC (Cyclorrapha), BN06D, G97D, GR84D, JS00DA, 
#' R77D, S80DCF, S80DCR, S80DMF, S93DA, W13D, JS00DN (Nematocera), S93DN (Nematocera), Sabo02DN (Nematocera)
#' All (10 equations: BN06D, G97D, GR84D, JS00DA, R77D, S80DCF, S80DCR, S80DMF, S93DA, W13D), 
#' Brachycera (2 equations:S93DB, Sabo02DB), Nematocera (3 equations: JS00DN, S93DN, Sabo02DN), Asilidae (2 equations: Sabo02DA, S93DB)
#' and Bombyliidae (2 equations: S93DB, Sabo02DBB)
#'
#' 
...
'S80DCF', 'S80DCR', 'S80DMF', 'S93DA', 'W13D', 'JS00DN', 
 'S93DN', 'Sabo02DN','All','Brachycera','Nematocera','Asilidae','Bombyliidae'")
      ...
      if (Eq == "All") out <- cbind(BN06D, G97D, GR84D, JS00DA, R77D, S80DCF, S80DCR, S80DMF, S93DA, W13D)
