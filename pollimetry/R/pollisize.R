...
#'                          R77H, S80HCF, S80HCR, S80HMF, S93HA, Sabo02H, W13H
#'                          Formicidae (13 equations): BN06HF, GR84F, JS00HF, R77A,
#'                          S80FCF, S80FCR, S80FMF, S93HF, S93HH, S93HI, BN06H1, G97H, G97F
#'                          Apidae: Sabo02HA
#'                          Braconidae: S93HB
#'                          S93HH (NOT SURE)
#'                          Ichneumonidae: S93HI
...
#' 
#' @export
pollisize=function(Type, mm, Eq = "DIP"){
if(Type == "HW") & any(!Eq %in% c("H97DB", 
                            "H97DN", 
                            "H97DA","H97LH","H97LR")){
  stop("Equation should be one of 'H97DB', 'H97DN','H97DA','H97LH','H97LR'")
} else {
    H97DB <- 0.655*(mm)^2.526
       H97DN <- 3.942*(mm)^3.106
       H97DA <- 1.999*(mm)^2.09
       H97LH <- 2.053*(mm)^2.804
       H97LR <- 1.634*(mm)^2.793
