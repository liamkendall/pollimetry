...
bodysize(x = example, taxa = "bee", type = "taxo")
#Liam, Region as random is considered, right? So the text should reflect that.
...
example <- cbind.data.frame(IT = c(1.2, 2.3), 
                            ...
                            Region = c("NorthAmerica","Europe"))
bodysize(x = example, taxa = "bee", type = "taxo") 
#Good, but can contain the same error message as above.
...
example <- cbind.data.frame(IT = c(1.2, 2.3), 
                            ...
                            Region = c("NorthAmerica","Europe"))
bodysize(x = example, taxa = "bee", type = "taxo") 
#We need a better error here. (as Above)
